      ...
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="flex-1 bg-white border border-gray-200 rounded-md overflow-hidden">
          <div className="p-5 space-y-5">
            {cartItems.length === 0 ? (
              ...
              cartItems.map((item) => (
                <div
                  key={item._id}
                  className="flex flex-col md:flex-row gap-4 pb-5 border-b border-gray-100"
                >
          ...
          <div className="p-5 bg-white border-t border-gray-100 flex justify-between items-center">
            ...
            <button
              onClick={clearCart}
              className="text-blue-600 border border-gray-200 px-5 py-2 rounded-md text-sm font-semibold"
            >
              Remove all
            </button>
          </div>
